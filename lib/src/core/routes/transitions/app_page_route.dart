...
class AppPageRoute<T> extends PageRoute<T> with AppRouteTransitionMixin<T> {
  AppPageRoute({
...
mixin AppRouteTransitionMixin<T> on PageRoute<T> {
  ...
  bool canTransitionTo(TransitionRoute<dynamic> nextRoute) {
    return nextRoute is AppRouteTransitionMixin && !nextRoute.fullscreenDialog;
  }
