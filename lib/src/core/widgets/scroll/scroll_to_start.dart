...
class _ScrollToStartState extends State<ScrollToStart> {
  ...
  void _scrollListener() {
    ...
    if (_hasSingleScrollPosition && _controller!.offset < mediaQuery.size.height && mounted) {
      setState(() {});
    }
  }
  ...
  void _scrollToStart(MediaQueryData mediaQuery) {
    if (!_hasSingleScrollPosition || _controller!.offset > mediaQuery.size.height * 5) {
  ...
  Widget build(BuildContext context) {
    ...
    final padding = config.bottomAppBar && route == RootScreen.route
        ? MainAppBar.height(context) + config.paddingValue
            ...
            child: AnimatedShiftedPosition(
              ...
              child: Padding(
                ...
                child: AppButton.raised(
                  ...
                  text: widget.text,
                  backgroundColor: appTheme.alternateCardColor,
