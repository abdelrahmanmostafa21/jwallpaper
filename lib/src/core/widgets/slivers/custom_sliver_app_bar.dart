...
typedef DecorationBuilder = Decoration Function(double minExtend, double maxExtend);
...
class _SliverAppBarState extends State<CustomSliverAppBar> with TickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    ...
    final topPadding = widget.primary ? MediaQuery.of(context).padding.top : 0.0;
...
class _SliverAppBarDelegate extends SliverPersistentHeaderDelegate {
  ...
  double get maxExtent =>
      math.max(topPadding + (expandedHeight ?? toolbarHeight + _bottomHeight), minExtent);
  ...
  Widget build(
    ...
    final extraToolbarHeight = math.max(minExtent - _bottomHeight - topPadding - toolbarHeight, 0);
    ...
    return floating ? _FloatingAppBar(child: flexibleSpaceBar) : flexibleSpaceBar;
  }
